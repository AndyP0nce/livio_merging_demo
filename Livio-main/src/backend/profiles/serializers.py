...
class ProfileCreationSerializer(ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['firstName', 'lastName', 'age', 'gender', 'gradeLevel', 'nationality', 'bio', 'has_roommate_post', 'profilePicture'] # these are the fields that it should expect and work with when deserialzing the JSON
...
class ProfileGetSerializer(ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['id', 'firstName', 'lastName', 'age', 'gender', 'gradeLevel', 'nationality', 'bio', 'has_roommate_post', 'profilePicture'] # these are the fields which the serializer/deserializer should worry about 
