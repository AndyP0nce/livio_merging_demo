...
class RoommatePostGetSerializer(ModelSerializer):
    ...
    class Meta:
        model = RoommatePost
        fields = ['title', 'description', 'originalPostDateTime', 'postLastUpdateDateTime', 'profile', 'features', 'funFact', 'numberOfPeopleInterested', 'budget', 'moveInDate'] # these are the fields which will be serialized to JSON format and etc
...
class RoommatePaginationSerializer(ModelSerializer):
    ...
    class Meta:
        model = RoommatePost
        fields = ['title', 'description', 'funFact', 'budget', 'moveInDate', 'features', 'profile', 'numberOfPeopleInterested']
